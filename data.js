  ...
  es: {
    ...
    benefits: {
      ...
      items: [
        ...
        { icon: "🎯", title: "Organizados por objetivo", text: "12 categorías claras: marketing, ventas, redes sociales, copywriting, negocios, diseño, productividad y más." },
  ...
  en: {
    ...
    benefits: {
      ...
      items: [
        ...
        { icon: "🎯", title: "Organized by goal", text: "12 clear categories: marketing, sales, social media, copywriting, business, design, productivity and more." },
